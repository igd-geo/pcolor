...
public class Illuminant {
	 ...
	 */
	public static final CIEXYZ F2 = CIEXYZ.fromxyY(0.37208f, 0.37529f, 1f);
	
	/**
	 * CIE F7, a broadband fluorescent illuminant. Approximates D65. 6500K.
	 */
	public static final CIEXYZ F7 = CIEXYZ.fromxyY(0.31292f, 0.32933f, 1f);
	
	/**
	 * CIE F11, a narrow tri-band fluorescent illuminant. 4000K.
	 */
	public static final CIEXYZ F11 = CIEXYZ.fromxyY(0.38052f, 0.37713f, 1f);
